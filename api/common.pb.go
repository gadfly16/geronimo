...
func (x *APIMsg) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*APIMsg) ProtoMessage() {}

func (x *APIMsg) ProtoReflect() protoreflect.Message {
	mi := &file_api_common_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use APIMsg.ProtoReflect.Descriptor instead.
func (*APIMsg) Descriptor() ([]byte, []int) {
	return file_api_common_proto_rawDescGZIP(), []int{0}
}

func (x *APIMsg) GetKind() int32 {
	if x != nil {
		return x.Kind
	}
	return 0
...
func (x *APIMsg) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
var file_api_common_proto_rawDesc = string([]byte{
	0x0a, 0x10, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x0c, 0x67, 0x65, 0x72, 0x6f, 0x6e, 0x69, 0x6d, 0x6f, 0x2e, 0x61, 0x70, 0x69,
	0x22, 0x66, 0x0a, 0x06, 0x41, 0x50, 0x49, 0x4d, 0x73, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x6b, 0x69,
	...
	0x28, 0x03, 0x52, 0x06, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x12, 0x1c, 0x0a, 0x09, 0x74, 0x69,
	0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x74,
	0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x42, 0x26, 0x5a, 0x24, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x79, 0x6f, 0x75, 0x72, 0x75, 0x73, 0x65, 0x72, 0x6e,
	0x61, 0x6d, 0x65, 0x2f, 0x67, 0x65, 0x72, 0x6f, 0x6e, 0x69, 0x6d, 0x6f, 0x2f, 0x61, 0x70, 0x69,
...
var file_api_common_proto_goTypes = []any{
	(*APIMsg)(nil), // 0: geronimo.api.APIMsg
}
